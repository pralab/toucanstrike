...
class DnnLin(End2EndModel):

	def __init__(self):
		super(DnnLin, self).__init__(10, 102400, 0, True)
	...
	def embedd_and_forward(self, x):
		...
		max_pooling1d_1 = torch.max_pool1d(conv1d_1, kernel_size=(4,), stride=(4,), padding=0, ceil_mode=False)
		conv1d_2 = self.conv1d_2(max_pooling1d_1)
		max_pooling1d_2 = torch.max_pool1d(conv1d_2, kernel_size=(4,), stride=(4,), padding=0, ceil_mode=False)
		conv1d_3 = self.conv1d_3(max_pooling1d_2)
		max_pooling1d_3 = torch.max_pool1d(conv1d_3, kernel_size=(4,), stride=(4,), padding=0, ceil_mode=False)
		conv1d_4 = self.conv1d_4(max_pooling1d_3)
		max_pooling1d_4 = torch.max_pool1d(conv1d_4, kernel_size=(4,), stride=(4,), padding=0, ceil_mode=False)
		conv1d_5 = self.conv1d_5(max_pooling1d_4)
		global_max_pooling1d_1 = torch.max_pool1d(input=conv1d_5, kernel_size=conv1d_5.size()[2:])
		global_average_pooling1d_1 = torch.avg_pool1d(input=conv1d_5, kernel_size=conv1d_5.size()[2:])
...
def load_model(model_path=None):
	linear = CClassifierEnd2EndMalware(DnnLin())
